...
class Torrent
{
     ...
     * @param              int $piece_length piece length (optional)
     */
    ...
    public function error()
    {
        ...
        $exception = self::$errors[0];

        return empty(self::$errors) ? false : $exception->getMessage();
    }
     ...
     *
     * @param string|array $announce  announce or scrape page url (optional, to request an alternative tracker BUT requirered for static call)
     * @param string       $hash_info torrent hash info (optional, requirered ONLY for static call)
     * @param int|float    $timeout   read timeout in seconds (optional, default to self::timeout 30s)
     *
     ...
     *
     * @param mixed $string string data or file path to decode
     *
     ...
     * @param              $piece_length integer piece length
     *
     ...
     *
     * @param mixed $void any param
     *
     * @return mixed any param
     */
     ...
     *
     * @return mixed|boolean file handle or false if error
     */
     ...
     * @param float|int $timeout http timeout (optional, default to self::timeout 30s)
     *
